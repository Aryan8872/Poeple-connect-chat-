...
UsersFirebaseRemoteDataSource  getUsersFirebaseRemoteDataSource (RoomUsersDatabase database , ErrorHandler errorHandler){
  return UsersFirebaseRemoteDataSourceImpl(database, errorHandler);
}

UsersRepository getUsersRepository(UsersFirebaseRemoteDataSource remoteDataSource){
  return UsersRepositoryImpl(remoteDataSource);
}

UsersRepository injectUserRepo(){
  return getUsersRepository(getUsersFirebaseRemoteDataSource(getRoomUserDataBase(), getErrorHandler()));
}